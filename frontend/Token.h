...
enum class TokenType
{
    ...
    PERIOD, DOT_DOT, COLON, COLON_EQUALS, SEMICOLON, COMMA,
    PLUS, MINUS, STAR, SLASH, LPAREN, RPAREN, LBRACKET, RBRACKET, CAROT,
    EQUALS, LESS_THAN, LESS_EQUALS, NOT_EQUALS, GREATER_THAN, GREATER_EQUALS,
...
static const string TOKEN_TYPE_STRINGS[] =
{
    ...
    "PLUS", "MINUS", "STAR", "SLASH", "LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "CAROT",
    "EQUALS", "LESS_THAN", "LESS_EQUALS", "NOT_EQUALS", "GREATER_THAN", "GREATER_EQUALS",
    "IDENTIFIER", "INTEGER", "REAL", "CHARACTER", "STRING", "EOF", "ERROR"
};
...
constexpr TokenType CAROT			= TokenType::CAROT;
...
constexpr TokenType NOT_EQUAL	 	= TokenType::NOT_EQUALS;
